...
<section id="two" class="spotlights">
	<section>
            <img src="assets/images/speakers/2020_Key_CJ_Schwartz.jpeg" alt="" data-position="center center" style="max-width: 100px; height: auto; />
		<div class="content">
			<div class="inner">
				<header class="major">
					<h3>CJ Schwartz</h3>
	...
	<section>
			<img src="assets/images/speakers/2020_Key_E_van_der_Knapp.jpg" alt="" data-position="top center" style="max-width: 100px; height: auto;/>
		<div class="content">
			<div class="inner">
				<header class="major">
...
for the Top Junior Faculty within the Ohio Research and Development Center at The Ohio State University; and the NSF Young Investigator Award in Plant Genome Research.
    ...
    <section>
            <img src="assets/images/speakers/2020_Key_I_Goldman.jpg" alt="" data-position="center center" style="max-width: 100px; height: auto;/>
        <div class="content">
            <div class="inner">
                <header class="major">
                    <h3>Irwin Goldman</h3>
    ...
    <section>
            <img src="assets/images/speakers/2020_Key_J_Dawson.jpg" alt="" data-position="top center" style="max-width: 100px; height: auto;/>
        <div class="content">
            <div class="inner">
                <header class="major">
                    <h3>Julie Dawson</h3>
...
<section id="four" class="spotlights">
	<section>
            <img src="assets/images/speakers/2020_Key_UC_B_Bailey.jpg" alt="" data-position="center center" style="max-width: 100px; height: auto;/>
		<div class="content">
			<div class="inner">
				<header class="major">
					<h3>Brian Bailey</h3>
	...
	<section>
			<img src="assets/images/speakers/2020_Key_UC_C_Diepenbrock.jpg" alt="" data-position="top center" style="max-width: 100px; height: auto;/>
		<div class="content">
			<div class="inner">
				<header class="major">
    ...
    <section>
            <img src="assets/images/speakers/2020_Key_UC_T_Magney.jpg" alt="" data-position="center center" style="max-width: 100px; height: auto;/>
        <div class="content">
            <div class="inner">
                <header class="major">
                    <h3>Troy Magney</h3>
