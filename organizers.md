...
<div class="row">
  <div class="column">
    <div class="card">
      ...
      <div class="container">
        <h2 style="color:#202520">Marie Klein</h2>
  ...
  <div class="column">
    <div class="card">
      ...
      <div class="container">
        <h2 style="color:#202520">Sadikshya Sharma</h2>
        <p class="title">Horticulture and Agronomy</p>
  ...
  <div class="column">
    <div class="card">
      ...
      <div class="container">
        <h2 style="color:#202520">Dante Leventini</h2>
        <p class="title">Horticulture and Agronomy</p>
  ...
  <div class="column">
    <div class="card">
      ...
      <div class="container">
        <h2 style="color:#202520">Mary-Francis LaPorte</h2>
  ...
  <div class="column">
    <div class="card">
      ...
      <div class="container">
        <h2 style="color:#202520">Katie Simpson-Johnson</h2>
  ...
  <div class="column">
    <div class="card">
      ...
      <div class="container">
        <h2 style="color:#202520">Matthew Davis</h2>
        <p class="title">Plant Biology</p>
        <p>Rotating</p>
      </div>
    </div>
  ...
  <div class="column">
    <div class="card">
      ...
      <div class="container">
        <h2 style="color:#202520">Kyle Rizzo</h2>
        <p class="title">Horticulture and Agronomy</p>
  ...
  <div class="column">
    <div class="card">
      ...
      <div class="container">
        <h2 style="color:#202520">Grey Monroe</h2>
